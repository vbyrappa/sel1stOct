...
public class MethodBlogModule9 {
...
//		viewBlog.click();
	...
	public static void learningTesting(String value) throws InterruptedException{
		driver.findElement(By.xpath(value)).click();
		Thread.sleep(3000);
	}
	
	public static void qaSelenium(String value) throws InterruptedException{
		driver.findElement(By.xpath(value)).click();
		Thread.sleep(3000);
	}
	
	public static void captureTopSel(String param) throws IOException, InterruptedException{
	...
	public static void qaVariousSel(String value) throws InterruptedException{
		driver.findElement(By.xpath(value)).click();
		Thread.sleep(3000);
	}
	
	public static void captureCompSel(String param) throws InterruptedException, IOException{
		File src= ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		 // now copy the  screenshot to desired location using copyFile //method
			FileUtils.copyFile(src, new File(param));
			Thread.sleep(2000);
	...
	public static void setpropSel(String value) throws InterruptedException{
		driver.findElement(By.xpath(value)).click();
		Thread.sleep(2000);
	}
