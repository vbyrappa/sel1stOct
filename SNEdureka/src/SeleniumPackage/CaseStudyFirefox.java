...
//		Get the Partial Link Text for the Link "Post-Graduate Program in Artificial Intelligence & Machine Learning"
	...
	//	System.out.println("Login Edureka PartialLink Text is displaying as : " + Plogin);
		...
		driver.findElement(By.id("si_popup_passwd")).sendKeys("V@suki123"); //Password through the id
		...
		Thread.sleep(1000);
		WebElement ddownEle = driver.findElementByXPath("(//*[@id='header-II']//section//a[contains(@class,'trackButton')])[127]");
		Select dropdown = new Select(ddownEle);
