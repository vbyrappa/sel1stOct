...
public class Module6 {
	...
	@Test(dependsOnMethods="applicationSignUp")
	...
	@Test(dependsOnMethods="applicationLogin")
	...
	@Test(dependsOnMethods="coursesAll")
	...
	@Test(dependsOnMethods="enrollDevOps")
	...
	@Test(dependsOnMethods="hadoopData")
	...
	@Test(dependsOnMethods = "openBrowserApplication")
	...
	driver.findElement(By.xpath("//*[@id='new_sign_up_mode']//button[contains(@class,'close')]")).click();
	Thread.sleep(1000);
	}
